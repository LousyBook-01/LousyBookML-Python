import numpy as np
import random
import lib.lousybook01.neural_lb01 as neural_lb01 # or just "import lib" or "import lib.lousybook" but then you need to change the neural network creation and stuff
